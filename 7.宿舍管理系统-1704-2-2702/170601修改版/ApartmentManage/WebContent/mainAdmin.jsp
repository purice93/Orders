...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
		<div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;" ><font color="white" size="6" >公寓管理系统</font></div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="dormManager?action=list"><i class="icon-chevron-right"></i>用户权限管理</a></li>
					<li><a href="dormBuild?action=list"><i class="icon-chevron-right"></i>公寓信息管理</a></li>
					<li><a href="student?action=list"><i class="icon-chevron-right"></i>学生信息管理</a></li>
					<li><a href="instructor?action=list"><i class="icon-chevron-right"></i>辅导员信息管理</a></li>
