...
<table width="760" height="352" border="1" align="center"
	  ...
	  <table width="100%" height="173" border="0" cellpadding="0" cellspacing="0">
        <tr>
		  ...
		  <s:form action="finishUpdate" method="post">
			<s:hidden name="studentid" value="%{id}"></s:hidden>
			<s:textfield name="fid" label="学　　号" value="%{rsid}"></s:textfield>
			
			<s:textfield name="fname" label="姓　　名" value="%{rsname}"></s:textfield>
	
			<s:textfield name="froom" label="寝室编号" value="%{rsroom}"></s:textfield>
		
			<s:textfield name="fmajor" label="专　　业" value="%{rsmajor}"></s:textfield>
		
			<s:textfield name="fclass" label="班　　级" value="%{rsclass}"></s:textfield>
			
			<s:textfield name="femail" label="联系方式" value="%{rsemail}"></s:textfield>
			<br />
