...
public class AdminDAO extends BaseHibernateDAO {
	...
	public Admin findById(java.lang.Integer id) {
		...
		try {
			Admin instance = (Admin) getSession().get("com.css.hib.Admin", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Admin instance) {
		...
		try {
			List results = getSession().createCriteria("com.css.hib.Admin")
	...
	public List findByAdminpassword(Object adminpassword) {
		return findByProperty(ADMINPASSWORD, adminpassword);
	}
