...
public class Game_P_con implements KeyListener{
	...
	public Game_P_con(JPanel jpanelPlayGame,JPanel jpone,Game_Play_JFrame game_Play_JFrame)
	{
		...
		mghThread=new MghThread(jpanelPlayGame,game_Play_JFrame,playImage.getAlImage().get(15),80,80);
		this.jpone=jpone;
	...
	public void keyPressed(KeyEvent e) {
		...
		else if(e.getKeyChar()=='j')
		{
			...
			System.out.println(game_Play_JFrame.getJnzb());
			if(bl)
			{ 
				bl=true;				
				jpanelPlayGame.remove(jpone);
