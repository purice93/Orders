...
public class InfoDialog extends JDialog implements MouseMotionListener,MouseListener
{
...
//	private MouseInfo  mouse;
	...
	public InfoDialog(Frame frame,boolean modal,MyPanel panel)
	{
		super(frame,modal);
		this.panel = panel;
	...
	public void paint(Graphics g)
	{
		...
		String context = new String("本游戏为Java awt和swing组件");
		g2.setFont(new Font("楷体",Font.BOLD,15));
		g2.setColor(Color.yellow);
		
		BasicGraphicsUtils.drawString(g2, context, 100, 35, 80);
		String context1 = new String("模拟的休闲小游戏《潜艇大战》");
		g2.setFont(new Font("楷体",Font.BOLD,15));
		g2.setColor(Color.yellow);
		BasicGraphicsUtils.drawString(g2, context1, 100, 35, 100);
		
		String context2 = new String("由于本人时间有限，没有对代码");
		g2.setFont(new Font("楷体",Font.BOLD,15));
		g2.setColor(Color.yellow);
		BasicGraphicsUtils.drawString(g2, context2, 100, 35, 120);
		
		String context3 = new String("进行优化和界面UI处理，所以有");
		g2.setFont(new Font("楷体",Font.BOLD,15));
		g2.setColor(Color.yellow);
		BasicGraphicsUtils.drawString(g2, context3, 100, 35, 140);
		
		String context4 = new String("很多的不足之处，仅做学习之用。");
		g2.setFont(new Font("楷体",Font.BOLD,15));
		g2.setColor(Color.yellow);
		BasicGraphicsUtils.drawString(g2, context4, 100, 35, 160);
