	...
	private static boolean gameStart() {
		...
		while (Numstone > 0) {
			...
			if(flag==1) {
				...
				System.out.println(programmer.getName()+" takes "+random+" stones, there are "+Numstone+" stones remaining."+"\n");
				flag=-1;
				if(Numstone==0) {
					System.out.println(programmer.getName()+" had to take last stone and You win the game.");
			...
			// Computer
				...
				Numstone-=random;
				System.out.println(man.getName()+" takes "+random+" stones, there are "+Numstone+" stones remaining.\n");
				
				if(Numstone==0) {
					System.out.println(man.getName()+" had to take last stone and lost in the game.");
					System.out.println("Thanks for playing.");
					return true;
				}
				flag = 1;
