...
<table width="760" height="50" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#00CCFF" class="border1">
  <tr>
    ...
    <img src="file:///D|/Workspaces/MyEclipse 8.5/graduation/src/com/css/images/p3.png" width="100%" height="100%">
        </form>
    </td>
  </tr>
</table>
...
<form action="adminlogin.action" method="post" class="STYLE1">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <table width="271" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="271" height="28" align="center" bgcolor="#0099FF" class="white">管 理 员 登 陆</td>
    </tr>
    <tr>
      <td height="26" align="center" bgcolor="#eeeeee">帐号
      <input name="adminname" type="text" id="adminname"></td>
    </tr>
    <tr>
      <td height="26" align="center" bgcolor="#eeeeee">密码
      <input name="adminpwd" type="password" id="adminpwd"></td>
    </tr>
    <tr>
      <td height="26" align="center" bgcolor="#EEEEEE"><input type="submit" name="Submit" value="登陆后台">
    </tr>
  </table>
    </tr>
    ...
    <td width="8" bgcolor="#CCCCCC"><span class="STYLE1"></span></td>
    <td width="566" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
