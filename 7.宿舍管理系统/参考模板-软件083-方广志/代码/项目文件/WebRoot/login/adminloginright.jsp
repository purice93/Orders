...
-->
	...
	<body>
		...
		<table width="760" height="113" border="1" align="center"
		...
		<table width="760" border="1" align="center" cellpadding="0"
			...
			<tr>
				<td height="29" background="/img/bg1.gif" bgcolor="#9999FF"
					...
					<a href="http://127.0.0.1:8080/graduation/" class="a1">首页</a> |
					<a href="http://127.0.0.1:8080/graduation/admin/help.jsp" class="a1">帮助信息</a> |
					<a href="http://127.0.0.1:8080/graduation/admin/help.jsp" class="a1">作者信息</a> |
					<a href="/bbsList.jsp" target="_blank" class="a1"></a>
				</td>
			</tr>
			<tr>
		...
		<table width="760" height="352" border="1" align="center"
			...
			<tr>
				<td width="526" height="350" valign="top">
					...
					<p align="center">
						<img align="middle"
							src="file:///D|/Workspaces/MyEclipse 8.5/graduation/src/com/css/images/1.bmp"
							width="760" height="137">
					</p>
				</td>
			</tr>
		</table>
